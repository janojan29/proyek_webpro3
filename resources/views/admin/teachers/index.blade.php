<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="card animate-fade-slide-up">
            <form method="GET" action="{{ route('admin.teachers.index') }}" class="filter-panel filter-form">
                <div class="filter-search-wrap">
                    ...
                    <input
                        ...
                        value="{{ $q }}"
                        class="filter-input"
                        placeholder="Cari nama, NIP, mapel, atau wali kelas..."
                    >
                </div>
                <div class="filter-actions">
                    ...
                    @if ($q !== '')
                        <a href="{{ route('admin.teachers.index') }}" class="btn-secondary px-5 h-[42px] flex items-center justify-center">
                            Reset
                        </a>
                    @endif
                </div>
                    ...
                    <tbody>
                        @forelse ($teachers as $teacher)
                            <tr class="table-row">
                                ...
                                <td class="py-3 px-4">
                                    @php
                                        $teacherRole = $teacher->getRoleNames()->first();
                                    @endphp
